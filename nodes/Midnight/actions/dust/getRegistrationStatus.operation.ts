...
export const description: INodeProperties[] = [
  {
    ...
    placeholder: 'stake1...',
    description: 'The Cardano stake key to check registration status for',
  },
];
...
export async function execute(
  ...
  const response = await midnightGraphQLRequest.call(this, dustQueries.getRegistrationStatus, {
    stakeKey: validatedStakeKey,
  });

  const data = (response as { registrationStatus: unknown }).registrationStatus;
